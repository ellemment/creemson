// app/creemson/components/themes/ThemesDocsAssets.tsx
import {
	CheckIcon,
	CopyIcon,
	CubeIcon,
...
import { TabNavDemo } from "#app/creemson/components/common/demo/tab-nav-demo";
import { Marker } from "#app/creemson/components/common/ui/Marker";
import { ThemesPanelBackgroundImage } from "#app/creemson/components/themes/ThemesPanelBackgroundImage";
import styles from "#app/creemson/styles/modules/ThemesDocsAssets.module.css";
import { allPeople } from "#app/creemson/utils/people.ts";
import { accentColors, themePropDefs } from "#app/creemson/utils/theme/props.ts";
...
export function ThemesScalingExample() {
	...
	const person = allPeople[6] || { name: "Unknown", image: "" }; // Provide a default value
